...
API_ID = get_int("API_ID") or int(input("16020063"))
API_HASH = get_str("API_HASH") or input("6c6105247dd669cc874e3f3a02a4b4a7")
BOT_TOKEN = get_str("BOT_TOKEN") or input("5661145723:AAEWpkNoRwyE47Ne5jNJhN1tv66z4GoqlOw")
MONGO_URL = get_str("MONGO_URL") or input("https://data.mongodb-api.com/app/data-puicq/endpoint/data/v1")
